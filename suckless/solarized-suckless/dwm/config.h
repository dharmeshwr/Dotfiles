...
static const char *fonts[] = {
    "MartianMono Nerd Font:size=11:antialias=true:autohint=true",
    "Font Awesome 6 Free Solid:size=13",
    "Noto Emoji:size=2:antialias=true:autohint=true",
    "JoyPixels:pixelsize-10:antialias=true:autohint=true"};
static const char dmenufont[] = "MartianMono Nerd Font:size=11:antialias=true:autohint=true";

static const char col_gray1[] = "#002b36"; // Background color
static const char col_gray2[] = "#073642"; // Inactive window border
static const char col_gray3[] = "#839496"; // Text color
static const char col_gray4[] = "#b3541d"; // Active window text color
static const char col_skin1[] = "#014657"; // Selected window background
static const char col_skin2[] = "#586e75"; // Selected window border
static const char col_skin3[] = "#657b83"; // Selected window border
...
static const char *dmenucmd[]        = {"env", "LANG=en_US.UTF-8", "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_skin1, "-sf", col_gray4, NULL};

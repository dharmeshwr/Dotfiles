...
static const char col_gray2[] = "#585b70"; // Inactive window border
static const char col_gray3[] = "#cdd6f4"; // Text color
static const char col_gray4[] = "#cdd6f4"; // Active window text color
static const char col_skin1[] = "#45475a"; // Selected window background
static const char col_skin2[] = "#45475a"; // Selected window border
static const char col_skin3[] = "#6c7086"; // Selected window border

...
// Gruvbox Light Theme
static const char col_gray1[] = "#fbf1c7"; // Background color (light beige)
static const char col_gray2[] = "#a89984"; // Inactive window border (grayish brown)
static const char col_gray3[] = "#3c3836"; // Text color (dark gray)
static const char col_gray4[] = "#fbf1c7"; // Active window text color (dark gray)
static const char col_skin1[] = "#458588"; // Selected window background (blue)
static const char col_skin2[] = "#458588"; // Selected window border (blue)
static const char col_skin3[] = "#83a598"; // Selected window border (lighter blue)
